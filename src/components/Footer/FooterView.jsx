    ...
    <div className="container">
      <div className="footer-content">
        ...
        <div className="footer-social">
          ...
          <a href="tel:+359888599590" className="footer-social__link" aria-label="Call TREND Studio" onClick={trackPhone}>
            <svg viewBox="0 0 24 24" fill="currentColor" aria-hidden="true" width="22" height="22">
          ...
          <a
            href="https://www.google.com/maps/search/TREND+Hair+Boutique+Studio+Tsar+Kaloyan+8+Sofia"
            target="_blank"
            rel="noopener noreferrer"
            className="footer-social__link"
