  ...
  <nav className={`navbar ${scrolled ? 'scrolled' : ''}`}>
    ...
    <div className="nav-container">
          ...
          <li className="nav-links__book-mobile">
            ...
            {phoneHref && (
              <a
                ...
                onClick={() => { trackPhone('mobile_menu')(); closeMenu() }}
              >
                &#9742; {callText}
              </a>
            )}
          ...
          <li className="nav-links__lang-mobile">
            <div className="lang-toggle" role="group" aria-label="Language">
              <button
                ...
                onClick={() => { trackLang('en')(); changeLanguage('en') }}
              ...
              <button
                ...
                onClick={() => { trackLang('bg')(); changeLanguage('bg') }}
      ...
      <div className="nav-actions">
        <a href={phoneHref} className="nav-phone" aria-label={callText} title={callText} onClick={trackPhone('navbar')}>
