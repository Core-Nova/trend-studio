...
const trackIG = () => trackEvent('share', { method: 'instagram', location: 'stories_cta' })
  ...
  return (
    ...
    >
      ...
      <div className="stories-viewer__cta">
        {phoneHref && (
          <a href={phoneHref} className="stories-viewer__cta-link stories-viewer__cta-call" onClick={trackPhone}>
            &#9742; {callText}
          </a>
        )}
        <a
