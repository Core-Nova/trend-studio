 ...
 *
 * Usage:
 *   node backend/scripts/fetch-reviews.mjs              → writes public/reviews.json
 *   node backend/scripts/fetch-reviews.mjs --override   → updates src/data/reviews.js (cached fallback)
 *   node backend/scripts/fetch-reviews.mjs --debug      → saves debug screenshots
 *
...
try {
  ...
  if (isOverride) {
    const output = `// Auto-generated by backend/scripts/fetch-reviews.mjs --override — do not edit manually
